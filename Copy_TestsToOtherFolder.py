...
def copy_test(inputs, output, id, n, qualified_name, keywords_to_remove_file, replace_in_imports):
...
if __name__ == '__main__':
    ...
    copy_test(args.source_path, args.dest_path, args.id, int(args.how_many_testsuite), args.qualified_name_class, args.keywords_to_remove_file,  args.replace_in_imports)
    print("Done!")