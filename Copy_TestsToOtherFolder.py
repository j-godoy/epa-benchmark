...
def copy_test(input, output, n, qualified_name, keywords_to_remove_file):
    def get_rename_test(java_file, class_name, new_test_file_name):
        new_file = ""
    ...
    while(i < n):
        ...
        if i >= n:
            break
        new_test_file_name = class_name + "_" + criterion + "_" + str(i) + "_ESTest.java"
        new_test_file_name_without_extension = new_test_file_name.split(".")[0]
        test_file_output = os.path.join(output, new_test_file_name)
        new_test_file = get_rename_test(test_file, class_name, new_test_file_name_without_extension)
...
if __name__ == '__main__':
    ...
    parser.add_argument("keywords_to_remove_file", help="keywords_to_remove file")
    args = parser.parse_args()
    copy_test(args.source_path, args.dest_path, int(args.how_many_testsuite), args.qualified_name_class, args.keywords_to_remove_file)
    print("Done!")