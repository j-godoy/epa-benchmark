	...
	bug_type_errprot  = "errprot"
		for (budget in budgets) {
			for(subj in subjects) {
				...
				default_pitmean = roundDecimals(round(mean(default_pit), digits=digits_size_to_percentage))
				...
				epatransition_pitmean = roundDecimals(round(mean(epatransition_pit), digits=digits_size_to_percentage))
				...
				epa_epax_pitmean = roundDecimals(round(mean(epa_epax_pit), digits=digits_size_to_percentage))
				...
				edges_pitmean = roundDecimals(round(mean(edges_pit), digits=digits_size_to_percentage))
				...
				lbeepatransition_pitmean = roundDecimals(round(mean(lbeepatransition_pit), digits=digits_size_to_percentage))
				...
				lbeepa_epax_pitmean = roundDecimals(round(mean(lbeepa_epax_pit), digits=digits_size_to_percentage))
				...
				lbeedges_pitmean = roundDecimals(round(mean(lbeedges_pit), digits=digits_size_to_percentage))
