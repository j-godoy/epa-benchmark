...
{
	cat("Subject", "EPA", "EPA", "EPAX", "EPAX", "EPAXP", "EPAXP", sep=", ")
	cat("\n")
...
RQ1 <- function()
{
	for(subj in subjects)
	{
		...
		for (budget in budgets)
		{
			...
			default_epaex = default_rows$EXCEPVAL
			...
			epatransition_epaexception_epaex = epatransition_epaexception_rows$EXCEPVAL
