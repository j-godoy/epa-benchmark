...
{
	cat("Subject","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP","VS EPAXP",
	"VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP","VS Evosuite+EPAXP", sep=", ")
	cat("\n")
...
RQ3_2 <- function()
{
	...
	for(subj in subjects)
	{
		...
		for (budget in budgets)
		{
			...
			strongmut_a12_vsepa = round(measureA(strongmut_pit, edges_pit),digits=decimals_size_a12)
			strongmut_p_value_vsepa = pValueRefactor(wilcox.test(strongmut_pit, edges_pit)$p.value)
			...
			strongmut_pf_a12_vsepa = round(measureA(strongmut_pf, edges_pf),digits=decimals_size_a12)
			strongmut_pf_p_value_vsepa = pValueRefactor(wilcox.test(strongmut_pf, edges_pf)$p.value)
			...
			mosa_strongmut_a12_vsepa = round(measureA(mosa_strongmut_pit, edges_pit),digits=decimals_size_a12)
			mosa_strongmut_p_value_vsepa = pValueRefactor(wilcox.test(mosa_strongmut_pit, edges_pit)$p.value)
			...
			mosa_strongmut_pf_a12_vsepa = round(measureA(mosa_strongmut_pf, edges_pf),digits=decimals_size_a12)
			mosa_strongmut_pf_p_value_vsepa = pValueRefactor(wilcox.test(mosa_strongmut_pf, edges_pf)$p.value)
						
			# RANDOOP
			randoop_rows  = subset(stats,SUBJ==subj & TOOL=='randoop' & BUD==budget & BUG_TYPE==bug_type_all)
			randoop_pit = randoop_rows$PIMUT
			randoop_a12_vsepa = round(measureA(randoop_pit, edges_pit),digits=decimals_size_a12)
			randoop_p_value_vsepa = pValueRefactor(wilcox.test(randoop_pit, edges_pit)$p.value)
			...
			randoop_pf_a12_vsepa = round(measureA(randoop_pf, edges_pf),digits=decimals_size_a12)
			randoop_pf_p_value_vsepa = pValueRefactor(wilcox.test(randoop_pf, edges_pf)$p.value)
			...
			strongmut_pf_a12_vsevoepaxp = round(measureA(strongmut_pf, evoepaxp_pf),digits=decimals_size_a12)
			strongmut_pf_p_value_vsevoepaxp = pValueRefactor(wilcox.test(strongmut_pf, evoepaxp_pf)$p.value)
			...
			mosa_strongmut_pf_a12_vsevoepaxp = round(measureA(mosa_strongmut_pf, evoepaxp_pf),digits=decimals_size_a12)
			mosa_strongmut_pf_p_value_vsevoepaxp = pValueRefactor(wilcox.test(mosa_strongmut_pf, evoepaxp_pf)$p.value)
			...
			randoop_pf_a12_vsevoepaxp = round(measureA(randoop_pf, evoepaxp_pf),digits=decimals_size_a12)
			randoop_pf_p_value_vsevoepaxp = pValueRefactor(wilcox.test(randoop_pf, evoepaxp_pf)$p.value)
			...
			strongmut_a12_vsevoepaxp,", ",strongmut_p_value_vsevoepaxp,", ",strongmut_pf_a12_vsevoepaxp,", ",strongmut_pf_p_value_vsevoepaxp,", ",mosa_strongmut_a12_vsevoepaxp,", ",mosa_strongmut_p_value_vsevoepaxp,", ",mosa_strongmut_pf_a12_vsevoepaxp,", ",mosa_strongmut_pf_p_value_vsevoepaxp,", ",randoop_a12_vsevoepaxp,", ",randoop_p_value_vsevoepaxp,", ",randoop_pf_a12_vsevoepaxp,", ",randoop_pf_p_value_vsevoepaxp,sep="")
			cat("\n")
		}
	}
}
