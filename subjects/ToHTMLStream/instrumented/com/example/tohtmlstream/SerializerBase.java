...
public abstract class SerializerBase
{
     ...
     */
    protected MockWriter m_writer = null;
...
//    }
     ...
     */
    public void addAttributes(MockAttributes atts) throws MockSAXException
    {
...
//    }
     ...
     * @see #startEntity
     */
    public void endEntity(String name) throws MockSAXException, MockIOException
    {
        if (name.equals("[dtd]"))
...
//     * @throws MockSAXException
//     */
//    public void entityReference(String name) throws MockSAXException
//    {
//
//        flushPending();
//
...
//    }
     ...
     */
    public void error(SAXParseException exc) throws MockSAXException {
    }

    /**
     * @see org.xml.sax.ErrorHandler#fatalError(SAXParseException)
     */
    public void fatalError(SAXParseException exc) throws MockSAXException {
     ...
     */
    public void warning(SAXParseException exc) throws MockSAXException 
    {
    }
...
//        
     ...
     * 
     */
    private void flushMyWriter() throws MockIOException
    {
        if (m_writer != null)
        {
            m_writer.flush();
...
//    }    
     ...
     * @throws MockIOException 
     */
    public void startDocument() throws MockSAXException, MockIOException
    {
     ...
     * @throws SAXException
     */
    protected void startDocumentInternal() throws MockSAXException, MockIOException
    {
        if (m_tracer != null)
            this.fireStartDoc();
    } 
     ...
     */
    public void addAttribute(String uri, String localName, String rawName, String type, String value) throws MockSAXException 
    {
        if (m_elemContext.m_startTagOpen)
        {
     ...
     * if the serializer is not DOM capable
     * @throws IOException An I/O exception occured
     * @see com.example.tohtmlstream#asDOM3Serializer()
     */
