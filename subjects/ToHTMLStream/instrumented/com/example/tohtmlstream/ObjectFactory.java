...
final class ObjectFactory {
    ...
    private static String findJarServiceProviderName(String factoryId)
    {
        ...
        // jkesselm]
        MockBufferedReader rd;
        try {
            rd = new MockBufferedReader(new MockInputStreamReader(is, "UTF-8"));
        } catch (MockUnsupportedEncodingException e) {
            rd = new MockBufferedReader(new MockInputStreamReader(is));
        }
