...
{
  /**
   * MockMalformedURIExceptions are thrown in the process of building a URI
   * or setting fields on a URI when an operation would result in an
   * invalid URI specification.
   *
   */
  public static class MockMalformedURIException extends IOException
  {
     ...
     * detail message.
     */
    public MockMalformedURIException()
    {
      super();
    }
     ...
     */
    public MockMalformedURIException(String p_msg)
    {
      super(p_msg);
    }
  }
...
//  private static boolean DEBUG = false;
   ...
   *                  empty)
   *
   * @throws MockMalformedURIException if p_uriSpec violates any syntax
   *                                   rules
   */
  public URI(String p_uriSpec) throws MockMalformedURIException
  {
   ...
   *                                  rules
   */
  public URI(URI p_base, String p_uriSpec) throws MockMalformedURIException
  {
   ...
   *                             null or empty)
   *
   * @throws MockMalformedURIException if p_scheme violates any
   *                                  syntax rules
   */
  public URI(String p_scheme, String p_schemeSpecificPart)
          throws MockMalformedURIException
  {

    if (p_scheme == null || p_scheme.trim().length() == 0)
    {
      throw new MockMalformedURIException(
   ...
   *                   is null)
   *
   * @throws MockMalformedURIException if any of the parameters violates
          ...
          throws MockMalformedURIException
  {
    ...
    if (p_scheme == null || p_scheme.trim().length() == 0)
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_SCHEME_REQUIRED, null)); //"Scheme is required!");
    }
   ...
   *                  is not null)
   *
   * @throws MockMalformedURIException if p_base is null and p_uriSpec
          ...
          throws MockMalformedURIException
  {
    ...
    if (colonIndex < 0)
    {
      if (p_base == null)
      {
        throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_NO_SCHEME_IN_URI, new Object[]{uriSpec})); //"No scheme found in URI: "+uriSpec);
      }
    }
    else
    {
   ...
   *
   * @throws MockMalformedURIException if URI does not have a conformant
   *                                  scheme
   */
  private void initializeScheme(String p_uriSpec) throws MockMalformedURIException
  {
    ...
    if (scheme.length() == 0)
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_NO_SCHEME_INURI, null)); //"No scheme found in URI.");
    }
    else
    {
      setScheme(scheme);
   ...
   * @param p_uriSpec the URI specification (cannot be null)
   *
   * @throws MockMalformedURIException if p_uriSpec violates syntax rules
   */
   ...
   * @throws MockMalformedURIException if p_uriSpec violates syntax rules
   */
  private void initializePath(String p_uriSpec) throws MockMalformedURIException
  {
    ...
    while (index < end)
    {
      ...
      {
        if ('\\' != testChar)
          throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_PATH_INVALID_CHAR, new Object[]{String.valueOf(testChar)})); //"Path contains invalid character: "
                                          //+ testChar);
      }
   ...
   *
   * @throws MockMalformedURIException if p_scheme is not a conformant
   *                                  scheme name
   */
  public void setScheme(String p_scheme) throws MockMalformedURIException
  {

    if (p_scheme == null)
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_SCHEME_FROM_NULL_STRING, null)); //"Cannot set scheme from null string!");
    }

    if (!isConformantSchemeName(p_scheme))
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_SCHEME_NOT_CONFORMANT, null)); //"The scheme is not conformant.");
    }
   ...
   *
   * @throws MockMalformedURIException if p_userinfo contains invalid
   *                                  characters
   */
  public void setUserinfo(String p_userinfo) throws MockMalformedURIException
  {
   ...
   *
   * @throws MockMalformedURIException if p_host is not a valid IP
   *                                  address or DNS hostname.
   */
  public void setHost(String p_host) throws MockMalformedURIException
  {
    ...
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, null)); //"Host is not a well formed address!");
    }
   ...
   *
   * @throws MockMalformedURIException if p_port is not -1 and not a
   *                                  valid port number
   */
  public void setPort(int p_port) throws MockMalformedURIException
  {
    ...
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_INVALID_PORT, null)); //"Invalid port number!");
    }
   ...
   *
   * @throws MockMalformedURIException if p_path contains invalid
   *                                  characters
   */
  public void setPath(String p_path) throws MockMalformedURIException
  {
   ...
   *
   * @throws MockMalformedURIException if p_addToPath contains syntax
   *                                  errors
   */
  public void appendPath(String p_addToPath) throws MockMalformedURIException
  {
    ...
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_PATH_INVALID_CHAR, new Object[]{p_addToPath})); //"Path contains invalid character!");
    }
   ...
   *
   * @throws MockMalformedURIException if p_queryString is not null and this
   ...
   *
   * @throws MockMalformedURIException if p_fragment is not null and this
   *                                  URI does not conform to the generic
   *                                  URI syntax or if the path is null
   */
  public void setFragment(String p_fragment) throws MockMalformedURIException
  {
    ...
    {
      throw new MockMalformedURIException(Utils.messages.createMessage(MsgKey.ER_FRAG_INVALID_CHAR, null)); //"Fragment contains invalid character!");
    }
    else
    {
