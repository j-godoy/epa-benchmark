...
public final class Encodings extends Object
{
     ...
     * @xsl.usage internal
     */
    static MockWriter getWriter(MockOutputStream output, String encoding)
        throws MockUnsupportedEncodingException
    {
        ...
        for (int i = 0; i < _encodings.length; ++i)
        {
            if (_encodings[i].name.equalsIgnoreCase(encoding))
            {
                try
                {
                	...
                	MockWriter osw = new MockOutputStreamWriter(output,javaName);
                    return osw; 
                }
        ...
        try
        {
            return new MockOutputStreamWriter(output, encoding);
        }
        catch (java.lang.IllegalArgumentException iae) // java 1.1.8
        {
            throw new MockUnsupportedEncodingException(encoding);
        }
    }
...
//                props.load(is);
        ...
        {
            throw new MockWrappedRuntimeException(ioe);
        }
    }
