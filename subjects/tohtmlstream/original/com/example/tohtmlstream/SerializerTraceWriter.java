 ...
 * @xsl.usage internal
 */
final class SerializerTraceWriter extends MockWriter
{
     ...
     */
    private final MockWriter m_writer;
     ...
     */
    public SerializerTraceWriter(MockWriter out, SerializerTrace tracer)
    {
        m_writer = out;
        m_tracer = tracer;
        setBufferSize(1024);
     ...
     */
    private void flushBuffer() throws MockIOException
    {
     ...
     */
    public void write(final int c) throws MockIOException
    {
        // send to the real writer
        if (m_writer != null)
            m_writer.write(c);
     ...
     *
     * @exception  MockIOException  If an I/O error occurs
     *
     ...
     * @exception  MockIOException  If an I/O error occurs
     */
    public void write(final String s) throws MockIOException
    {
        // send to the real writer
        if (m_writer != null)
            m_writer.write(s);
