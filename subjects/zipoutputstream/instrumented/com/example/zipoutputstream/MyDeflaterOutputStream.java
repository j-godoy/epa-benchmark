 ...
 */
public class MyDeflaterOutputStream extends FilterOutputStream {
	/**
	 ...
	 *                if size is <= 0
	 */
	public MyDeflaterOutputStream(OutputStream out, Deflater def, int size) {
		super(out);
	 ...
	 *            the compressor ("deflater")
	 */
	public MyDeflaterOutputStream(OutputStream out, Deflater def) {
		this(out, def, 512);
	}
