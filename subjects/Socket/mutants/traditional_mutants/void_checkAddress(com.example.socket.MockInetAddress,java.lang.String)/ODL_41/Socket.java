...
public class Socket
{
    ...
    private  int connect0( com.example.socket.MockSocketAddress endpoint )
    ...
    private  int connect0( com.example.socket.MockSocketAddress endpoint, int timeout )
        throws java.io.IOException
    {
        try {
        ...
        } finally 
{
    ...
    private  int bind0( com.example.socket.MockSocketAddress bindpoint )
    ...
    private  void checkAddress( com.example.socket.MockInetAddress addr, java.lang.String op )
    {
        ...
        if (!(addr instanceof com.example.socket.MockInet4Address || addr instanceof com.example.socket.MockInet6Address)) {
            throw new java.lang.IllegalArgumentException( ": invalid address type" );
        }
    }
    ...
    private  com.example.socket.Pair<Integer,InputStream> getInputStream0()
        throws java.net.SocketException, java.io.IOException
    {
        try {
    ...
    private  com.example.socket.Pair<Integer,OutputStream> getOutputStream0()
        throws java.net.SocketException, java.io.IOException
    {
        try {
