...
public class JDBCResultSet implements com.example.resultset.MockResultSet
{
        ...
        throws com.example.resultset.MockSQLException, java.lang.Exception
    {
        ...
        com.example.resultset.MockResultMetaData metaData = new com.example.resultset.MockResultMetaData( columnLabels, colIndexes, columnLabels.length, columnLabels.length );
