...
class StringTokenizer implements Enumeration {
    ...
    private boolean isnextElementEnabled() {
        return isNextTokenEnabled();
    }

    @EpaActionPrecondition(name = "countTokens()")
    private boolean iscountTokensEnabled() {
        return currentPosition >= maxPosition || delimiters != null;
    }
}