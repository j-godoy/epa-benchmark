...
//	private boolean finished;
	 ...
	 *                than 0xFFFF bytes
	 */
//	@EpaAction(name = "setComment(String)")
...
/*
	...
	@EpaActionPrecondition(name = "closeEntry")
	private boolean isCloseEntryEnabled() {
		return !closed;
	}

	@EpaActionPrecondition(name = "putNextEntry")
