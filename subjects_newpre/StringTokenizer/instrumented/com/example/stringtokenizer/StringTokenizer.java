...
public class StringTokenizer implements Enumeration<Object> {
	 ...
	 */
	@EpaAction(name = "StringTokenizer(String,String,boolean)")
	public StringTokenizer(String str, String delim, boolean returnDelims) {
		this(str,delim,returnDelims,null);
	}

	private StringTokenizer(String str, String delim, boolean returnDelims, Object object) {
		currentPosition = 0;
		newPosition = -1;
		delimsChanged = false;
		this.str = str;
	 ...
	 * @exception NullPointerException if str is <CODE>null</CODE>
	 */
	@EpaAction(name = "StringTokenizer(String,String)")
	 ...
	 */
	@EpaAction(name = "nextToken(String)")
...
//		return delimiters!=null;
	...
	private boolean isNextTokenEnabled() {
		// need to add a restriction over newPosition
		return currentPosition<maxPosition && newPosition < maxPosition && maxPosition>=1;
	}

	@EpaState(name = "S1")
	private boolean queryForS1() {
		return isHasMoreElementsEnabled() && isNextTokenEnabled();
	}
