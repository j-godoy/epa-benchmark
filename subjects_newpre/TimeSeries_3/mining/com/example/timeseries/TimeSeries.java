...
public class TimeSeries extends Series implements Cloneable, Serializable {
     ...
     */
    @EpaAction(name="TimeSeries(Comparable)")
     ...
     */
    @EpaAction(name="getDomainDescription")
     ...
     */
    @EpaAction(name="setDomainDescription")
     ...
     */
    @EpaAction(name="getRangeDescription")
     ...
     */
    @EpaAction(name="setRangeDescription")
     ...
     */
    @EpaAction(name="getMaximumItemCount")
     ...
     */
    @EpaAction(name="setMaximumItemCount(int)")
     ...
     */
    @EpaAction(name="getMaximumItemAge")
     ...
     */
    @EpaAction(name="setMaximumItemAge")
     ...
     *     an empty series).
     */
    @EpaAction(name="getTimePeriodClass")
     ...
     */
    @EpaAction(name="getDataItem(index)")
     ...
     * @see #getDataItem(int)
     */
    @EpaAction(name="getDataItem(RegularTimePeriod)")
     ...
     */
    @EpaAction(name="getTimePeriod(int)")
     ...
     */
    @EpaAction(name="getNextTimePeriod")
     ...
     */
    @EpaAction(name="getTimePeriodsUniqueToOtherSeries(TimeSeries)")
     ...
     * @return The index.
     */
    @EpaAction(name="getIndex(RegularTimePeriod)")
     ...
     * @return The value (possibly <code>null</code>).
     */
    @EpaAction(name="getValue(RegularTimePeriod)")
     ...
     *              permitted).
     */
    @EpaAction(name="add(TimeSeriesDataItem)")
    public void add(TimeSeriesDataItem item) {
        add_0(item);
        //add(item, true);
    }

    private void add_0(TimeSeriesDataItem item) {
        add(item, true);
    }
     ...
     */
    @EpaAction(name="add(TimeSeriesDataItem,boolean)")
     ...
     */
    @EpaAction(name="add(RegularTimePeriod,double)")
     ...
     * @param notify  notify listeners?
     */
    @EpaAction(name="add(RegularTimePeriod,double,boolean)")
     ...
     */
    @EpaAction(name="add(RegularTimePeriod,Number)")
     ...
     * @param notify  notify listeners?
     */
    @EpaAction(name="add(RegularTimePeriod,Number,boolean)")
     ...
     * @param value  the value (<code>null</code> permitted).
     */
    @EpaAction(name="update(RegularTimePeriod,Number)")
     ...
     */
    @EpaAction(name="update(int,Number)")
     ...
     */
    @EpaAction(name="addAndOrUpdate(TimeSeries)")
     ...
     */
    @EpaAction(name="addOrUpdate(RegularTimePeriod,double)")
     ...
     *         item was overwritten.
     */
    @EpaAction(name="addOrUpdate(RegularTimePeriod,Number)")
    public TimeSeriesDataItem addOrUpdate(RegularTimePeriod period,
                                          Number value) {
     ...
     * @since 1.0.14
     */
    @EpaAction(name="addOrUpdate(TimeSeriesDataItem)")
     ...
     */
    @EpaAction(name="removeAgedItems(boolean)")
     ...
     *                sent to registered listeners IF any items are removed.
     */
    @EpaAction(name="removeAgedItems(long,boolean)")
     ...
     *                permitted).
     */
    @EpaAction(name="delete(RegularTimePeriod)")
     ...
     * @since 1.0.14
     */
    @EpaAction(name="delete(int,int,boolean)")
     ...
     */
    @EpaAction(name="createCopy(int,int)")
    ...
    private TimeSeries createCopy_0(int start, int end)
            throws CloneNotSupportedException {
        if (start < 0) {
            throw new IllegalArgumentException("Requires start >= 0.");
        }
     ...
     * @throws CloneNotSupportedException if there is a cloning problem.
     */
    @EpaAction(name="createCopy(RegularTimePeriod,RegularTimePeriod)")
    public TimeSeries createCopy(RegularTimePeriod start, RegularTimePeriod end)
        ...
        if (emptyRange) {
            ...
            return createCopy_0(startIndex, endIndex);
        }
    ...
    @EpaActionPrecondition(name = "getDomainDescription")
    private boolean isgetDomainDescriptionEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "setDomainDescription")
    private boolean issetDomainDescriptionEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "getRangeDescription")
    private boolean isgetRangeDescriptionEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "setRangeDescription")
    private boolean issetRangeDescriptionEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "getItemCount")
    private boolean isgetItemCountEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "getItems")
    private boolean isgetItemsEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "getMaximumItemCount")
    private boolean isgetMaximumItemCountEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "setMaximumItemCount(int)")
    private boolean issetMaximumItemCountintEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "getMaximumItemAge")
    private boolean isgetMaximumItemAgeEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "setMaximumItemAge")
    private boolean issetMaximumItemAgeEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "getTimePeriodClass")
    private boolean isgetTimePeriodClassEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "getDataItem(index)")
    private boolean isgetDataItemindexEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "getDataItem(RegularTimePeriod)")
    private boolean isgetDataItemRegularTimePeriodEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "getTimePeriod(int)")
    private boolean isgetTimePeriodintEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "getNextTimePeriod")
    private boolean isgetNextTimePeriodEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "getTimePeriods")
    private boolean isgetTimePeriodsEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "getTimePeriodsUniqueToOtherSeries(TimeSeries)")
    private boolean isgetTimePeriodsUniqueToOtherSeriesTimseSeriesEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "getIndex(RegularTimePeriod)")
    private boolean isgetIndexRegularTimePeriodEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "getValue(int)")
    private boolean isgetValueintEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "getValue(RegularTimePeriod)")
    private boolean isgetValueRegularTimePeriodEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "add(TimeSeriesDataItem)")
    private boolean isaddTimeSeriesDataItemEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "add(TimeSeriesDataItem,boolean)")
    private boolean isaddTimeSeriesDataItembooleanEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "add(RegularTimePeriod,double)")
    private boolean isaddRegularTimePerioddoubleEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "add(RegularTimePeriod,double,boolean)")
    private boolean isaddRegularTimePerioddoublebooleanEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "add(RegularTimePeriod,Number)")
    private boolean isaddRegularTimePeriodNumberEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "add(RegularTimePeriod,Number,boolean)")
    private boolean isaddRegularTimePeriodNumberbooleanEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "update(RegularTimePeriod,Number)")
    private boolean isupdateRegularTimePeriodNumberEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "update(int,Number)")
    private boolean isupdateintNumberEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "addAndOrUpdate(TimeSeries)")
    private boolean isaddAndOrUpdateTimeSeriesEnabled() {
        return true;
    }

    @EpaActionPrecondition(name = "addOrUpdate(RegularTimePeriod,double)")
    private boolean isaddOrUpdateRegularTimePerioddoubleEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "addOrUpdate(RegularTimePeriod,Number)")
    private boolean isaddOrUpdateRegularTimePeriodNumberEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "addOrUpdate(TimeSeriesDataItem)")
    private boolean isaddOrUpdateTimeSeriesDataItemEnabled() {
        return this.data != null && !this.data.isEmpty();
    }

    @EpaActionPrecondition(name = "removeAgedItems(boolean)")
    private boolean isremoveAgedItemsbooleanEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "removeAgedItems(long,boolean)")
    private boolean isremoveAgedItemslongbooleanEnabled() {
        return this.timePeriodClass != null;
    }
    ...
    @EpaActionPrecondition(name = "delete(RegularTimePeriod)")
    private boolean isdeleteRegularTimePeriodEnabled() {
        return this.data != null;
    }
    ...
    @EpaActionPrecondition(name = "delete(int,int,boolean)")
    private boolean isdeleteintintbooleanEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "clone")
    private boolean iscloneEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "createCopy(int,int)")
    private boolean iscreateCopyintintEnabled() {
        return this.data != null;
    }

    @EpaActionPrecondition(name = "createCopy(RegularTimePeriod,RegularTimePeriod)")
    private boolean iscreateCopyRegularTimePeriodRegularTimePeriodEnabled() {
        return this.data != null;
    }
